  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-16">
      ...
      <div className="mt-12 bg-blue-50 p-8 rounded-2xl text-center">
        ...
        <a href="mailto:pharmacy@mailorderpharmacy.io?subject=Transfer Request for {med.name}" className="inline-block bg-blue-600 text-white font-bold py-3 px-8 rounded-lg hover:bg-blue-700 transition">
